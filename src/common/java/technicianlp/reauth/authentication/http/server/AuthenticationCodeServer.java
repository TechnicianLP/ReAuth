 ...
 * <br>
 * Class provides encapsulation of the jdk-builtin {@link HttpServer}. The API provided by the
 * {@link com.sun.net.httpserver} package is an official and documented API since Java 6. While the API should be
 * available in every major java distribution, it is an optional API and may therefore be missing in rare cases. This is
 * denoted by both the {@code jdk.Exported} Annotation and
 * <a href="https://docs.oracle.com/en/java/javase/17/docs/api/index.html">online documentation</a>.
 * <br>
 * The HttpServer is started on the supplied Executor. After the code has been received the future is completed
 * synchronously and the server automatically {@link #stop(boolean) stops} asynchronously.
 */
public final class AuthenticationCodeServer {
    ...
    public AuthenticationCodeServer(int port, String loginUrl, CompletableFuture<String> codeFuture,
                                    Executor executor) throws IOException, NoClassDefFoundError {
