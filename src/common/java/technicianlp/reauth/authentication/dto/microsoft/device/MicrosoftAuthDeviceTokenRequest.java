...
/**
 * Request Payload for the /token Endpoint of the Microsoft Identity Platform. Payload is used for polling the endpoint
 * as described in the device code flow.
 *
