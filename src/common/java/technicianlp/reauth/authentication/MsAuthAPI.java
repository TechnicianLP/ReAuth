...
public enum MsAuthAPI {
    ...
    public static MicrosoftAuthResponse redeemAuthorizationCode(String code, String pkceVerifier) throws
    ...
    public static MicrosoftAuthDeviceResponse requestDeviceCode(boolean persist) throws UnreachableServiceException,
    ...
    public static Response<MicrosoftAuthResponse> redeemDeviceCode(String deviceCode) throws
    ...
    public static MicrosoftAuthResponse redeemRefreshToken(String refreshToken) throws UnreachableServiceException,
        InvalidResponseException {
        MicrosoftAuthRefreshRequest request = new MicrosoftAuthRefreshRequest(refreshToken);
        return HttpUtil.performFormRequest(urlMicrosoftToken, request);
    }

    public static XboxAuthResponse authenticateXASU(String token) throws UnreachableServiceException,
        InvalidResponseException {
    ...
    public static MojangAuthResponse authenticateMojang(String xstsToken, String uhs) throws
        UnreachableServiceException, InvalidResponseException {
        MojangAuthRequest request = new MojangAuthRequest(xstsToken, uhs);
        return HttpUtil.performJsonRequest(urlMojangLogin, request);
    }

    public static ProfileResponse fetchProfile(String accessToken) throws UnreachableServiceException,
        InvalidResponseException {
