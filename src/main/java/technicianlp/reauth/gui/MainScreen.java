...
public final class MainScreen extends AbstractScreen {
    ...
    public final void initGui() {
        ...
        SaveButton.ITooltip saveButtonTooltip = (mouseX, mouseY) -> {
            this.drawHoveringText(this.fontRendererObj.listFormattedStringToWidth(I18n.format("reauth.gui.button.save.tooltip"), 250), mouseX, mouseY, this.fontRendererObj);
        ...
        if (ReAuth.versionCheck.getStatus() == VersionChecker.Status.OUTDATED) {
