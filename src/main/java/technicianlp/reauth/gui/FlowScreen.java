    ...
    public final void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (String line : lines) {
            if (line.startsWith("$")) {
                ...
                GL11.glPushMatrix();
                GL11.glScalef(2, 2, 1);
                this.fontRendererObj.drawStringWithShadow(line, (float) (this.centerX - this.fontRendererObj.getStringWidth(line)) / 2, (float) y / 2, 0xFFFFFFFF);
                y += 18;
                GL11.glPopMatrix();
            } else {
                this.fontRendererObj.drawStringWithShadow(line, (float) (this.centerX - this.fontRendererObj.getStringWidth(line) / 2), (float) y, 0xFFFFFFFF);
                y += 9;
            }
        }
    }
