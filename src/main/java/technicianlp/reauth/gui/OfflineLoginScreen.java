...
public final class OfflineLoginScreen extends AbstractScreen {
    ...
    public final void initGui() {
        ...
        this.username = new GuiTextField(this.fontRendererObj, this.centerX - BUTTON_WIDTH / 2, this.centerY - 5, BUTTON_WIDTH, 20);
    ...
    public final void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.fontRendererObj.drawStringWithShadow(I18n.format("reauth.gui.auth.username"), this.centerX - (BUTTON_WIDTH / 2), this.centerY - 15, 0xFFFFFFFF);
