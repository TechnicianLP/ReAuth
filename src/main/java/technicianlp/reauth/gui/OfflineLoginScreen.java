...
public final class OfflineLoginScreen extends AbstractScreen {
    ...
    public void init() {
        ...
        this.confirm = new Button(this.centerX - BUTTON_WIDTH / 2, this.baseY + this.screenHeight - 42, BUTTON_WIDTH, 20, new TranslatableComponent("reauth.gui.button.username"), (b) -> this.performUsernameChange());
