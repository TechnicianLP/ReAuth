...
public final class ProfileList {
    ...
    public final void storeProfile(Profile profile) {
        ...
        category.setPropertyOrder(new ArrayList<>(ProfileConstants.getOrderedProfileKeys()));
    ...
    private void correctProfile(ConfigCategory profile) {
        ...
        profile.setPropertyOrder(new ArrayList<>(ProfileConstants.getOrderedProfileKeys()));
    }
