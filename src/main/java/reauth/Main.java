...
@Mod(modid = "reauth", name = "ReAuth", version = "3.4.1", guiFactory = "reauth.GuiFactory", canBeDeactivated = true, clientSideOnly = true, acceptedMinecraftVersions = "[1.11,1.11.2]", certificateFingerprint = "cac6b8578b012cf31142c980b01c13ddb795846c")
