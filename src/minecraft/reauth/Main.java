...
@Mod(modid = "reauth", name = "ReAuth", acceptedMinecraftVersions = "[1.5.2]", version = "3.5.0", certificateFingerprint = "aa395513cd0890f9c69d4229ac5d779667421c85")
public class Main {
        ...
        TickRegistry.registerTickHandler(new ITickHandler() {
            ...
            public void tickStart(EnumSet<TickType> type, Object... tickData) {
                ...
                if (gui instanceof GuiMultiplayer && !(gui instanceof GuiMultiplayerExtended)) {
                    GuiScreen gc = ReflectionHelper.getPrivateValue(GuiMultiplayer.class, (GuiMultiplayer) gui, "field_74025_c", "parentScreen");
